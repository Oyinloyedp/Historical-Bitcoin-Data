...
# NETWORK DIFFICULTY
DifficultyLevel = 2036671.089
NumberofNodes=6
List=[2026093526950.24,385922576561.95,289441932421.462,1640170950388.29,12253041805841.9,385922576561.95]
length= len(List)
...
workbook = xlsxwriter.Workbook('POWWW.xlsx')
